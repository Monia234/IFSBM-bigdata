...
EXP<-read.csv2("https://raw.githubusercontent.com/DITEP/IFSBM-bigdata/master/TP_IFSBM_module12/Rescue/EXPlung_gbm.csv", row.names = 1)
CLINIC<-read.csv2("https://raw.githubusercontent.com/DITEP/IFSBM-bigdata/master/TP_IFSBM_module12/Rescue/Cliniclung_gbm.csv", row.names = 1)
TCGAdata<-list()
TCGAdata["EXP"]<-EXP
