...
```{r}
names(TCGAdata)
#write.csv2(TCGAdata$EXP,"C:/Users/L_VERLINGUE/Desktop/Presentation/IFSBM/2019/EXPlung_gbm.csv")
#write.csv2(TCGAdata$CLINIC,"C:/Users/L_VERLINGUE/Desktop/Presentation/IFSBM/2019/Cliniclung_gbm.csv")
...
The ```survfit()``` function of the survival package compute the cumulativee probability of survival that takes into acount censored data in the calculation.
...
Previously your task was to classify the histologies from expression data. Your new task is to predict survival of patients, still from the expression of data.
Modeling survival data is a long standing discipline. With the emergence of molecular analysis it has become a big challenge worldwide. As you will see in this exemple it is much more complicated than histology classification.
