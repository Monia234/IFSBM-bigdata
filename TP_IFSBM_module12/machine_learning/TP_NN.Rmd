...
To use both with R (gold standard is to use it with python), it is recommended you install [anaconda](https://www.anaconda.com/distribution/#download-section). Anaconda is a python/R based environment architecture that will provide almost all what you need to run Tensorflow and Keras.

Dowload Anaconda may take some time. *Look at the slides!* (computational graphs and neural nets)

Then, load and install Keras.
```{r}
